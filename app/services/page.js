...
export default function Home() {
  return (
    <>
      ...
      <section className="hero">
        <div className="wrap">
          ...
          <div className="btn-row rise rise-4">
            ...
            <Link className="btn btn--ghost" href={CTA.secondary.href}>{CTA.secondary.label}</Link>
          </div>
      ...
      {/* 2 — Market problem + animated proof */}
      <section className="section panel">
        <div className="wrap">
          <div className="split">
            ...
            <div>
              <p>
                Companies are gathering again with confidence — but optimism isn&rsquo;t the same as proof. Most
                gatherings still end with a full room, good energy, and no clear answer when leadership asks what
                actually changed.
              </p>
      ...
      {/* 5 — Interactive Agenda Method */}
      <section className="section">
        <div className="wrap">
          <Kicker>The Agenda Method</Kicker>
          <h2 style={{ maxWidth: "20ch", marginBottom: "0.75rem" }}>
            A six-step method for gatherings that matter.
          </h2>
          <p className="muted" style={{ marginBottom: "2.5rem", maxWidth: "52ch" }}>
            Select a step to see how we design it. The agenda is the architecture for the entire experience.
          </p>
          <AgendaMethodInteractive />
          <div className="btn-row">
            <Link className="btn btn--ghost" href="/method">{CTA.secondary.label}</Link>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="stat-band" style={{ marginTop: "3rem" }}>
            <div className="stat">
              ...
              <div className="label">in capital investment in Greater Phoenix since 2020, including TSMC&rsquo;s $165B commitment.<span className="src">Visit Phoenix</span></div>
            </div>
            <div className="stat">
              <div className="figure">4&times;</div>
              <div className="label">as many medical and high-tech meetings hosted in the region since 2019.<span className="src">Visit Phoenix</span></div>
            </div>
            <div className="stat">
              <div className="figure">$453.7M</div>
              <div className="label">in estimated economic impact from 70 conventions at the Phoenix Convention Center in 2025.<span className="src">City of Phoenix</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section ink-bg">
        <div className="wrap split">
          ...
          <div>
            <p>
              The firms that win the next decade of event growth will be the ones that can prove outcomes, not
              just attendance. That is the entire premise of how we work.
            </p>
            <p style={{ marginBottom: 0, color: "var(--gold-soft)", fontFamily: "var(--serif)", fontSize: "var(--step-1)" }}>
      ...
      <section className="section ink-bg">
        <div className="wrap">
          ...
          <div className="btn-row">
            <Link className="btn btn--ghost" href={CTA.primary.href}>{CTA.primary.label}</Link>
          </div>
        </div>
      </section>
    </>
